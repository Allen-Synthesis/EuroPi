...
class PresetManager(EuroPiScript):
    ...
    def save_state(self):
        ...
        state = {
            ...
            "loaded preset": self.loaded_preset
        }
    ...
    def draw_current_preset(self):
        ...
        for index, value in enumerate(values):
            ...
            oled.rect(x, y, self.box_width, self.box_height, 1) if index != self.selected_preset else oled.fill_rect(x, y, self.box_width, self.box_height, 1)
