...
class Walking(EuroPiScript):
    def __init__(self):
        ...
        self.plant_text = bytearray_to_framebuffer(
            b'\xe4\x00\x00\x80\x00\x00\x00\x00\x00\x00\x01\xf0\x00\x00\x00\x00\x94\x1c9\xe3\x80\x00\x00\x00\x00\x00\x00DI\x1c\x00\x00\x94"D\x84\x00\x00\x00\x00\x00\x00\x00DV\xa2\x00\x00\xe4"D\x83\x00\x00\x00\x00\x00\x00\x00DP\xa2\x00\x00\x84\xa2D\x90\x80\x00\x00\x00\x00\x00\x00DP\xa2\x00\x00\x83\x1dDg\x00\x00\x00\x00\x00\x00\x01\x83\x90\xbc\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x008\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00T\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00T\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x8c\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x84\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00@ \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
            128, 32)
        
        self.blank_image = bytearray_to_framebuffer(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00', 7, 9)
        self.filled_image = bytearray_to_framebuffer(b'\xfe\xfe\xfe\xfe\xfe\xfe\xfe\xfe\xfe', 7, 9)
    ...
    def increment_plants(self):
        try:
            plant_too_close = False if self.plants[-1][1] >= 3 else True	# plant_too_close prevents overlapping plants that are closer than the width of one clock pulse
        except IndexError:
        ...
        for plant in self.plants:
            ...
            if plant[1] == self.plant_despawn_x:	# If the plant has got far enough to the left to despawn
                ...
                oled.blit(plant[0], OLED_WIDTH - plant[1], self.character_y + 1)	# Draw the plant at its current location
    ...
    def tick(self, show=True):
        ...
        display_dither(self.left_limit + 6, 28, 0)
        oled.blit(self.blank_image, self.left_limit - 1, 22)
