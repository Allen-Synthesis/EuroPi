...
class OscControl(EuroPiScript):
    def __init__(self):
        ...
        self.server = OpenSoundServer(self.config.PORT)
    ...
    def config_points(cls):
        return [
            ...
            configuration.integer("PORT", default=9000, minimum=0, maximum=65535),
        ]
    ...
    def main(self):
        ...
        #timer = Timer()
        #timer.init(freq=10, mode=Timer.PERIODIC, callback=self.on_status_tick)
