...
script already bundled then you will need to manually install it by moving files onto the EuroPi.
...
Edit menu.py to include the Trigger to Gate script in the menu. Add the following lines:
