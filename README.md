...
**Hardware**: Details of the hardware can be found at [hardware/README.md](/hardware/README.md). Additionally the [BoM](hardware/bill_of_materials.md) and the [build guild](hardware/bill_of_materials.md) can be found in the hardware folder.
